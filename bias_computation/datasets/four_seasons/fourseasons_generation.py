...
if __name__ == '__main__':
    ...
    parser.add_argument("--fourseasons_dir", type=str, default="/storage/local/mutti/projects/TLIO_dev/Dataset/4s_no_h5py")
    parser.add_argument("--out_dir", type=str, default="/storage/local/mutti/projects/TLIO_dev/Dataset/4s_no_h5py")
